                ...
                <Col lg="7" className='text-center text-lg-start'>
                    <div className="hero-content pe-lg-6 fs-sm-xl col-xl-9">
                        ...
                        <ul className="list-unstyled d-inline-flex flex-wrap gap-3">
                            <a target="_blank" href="https://www.pinksale.finance/launchpad/0xc4351CdF4d91903C0Ab250694F92C2a9Ff382be8?chain=BSC"><button className="btn btn-primary shadow rounded-pill">Buy Presale</button></a>
